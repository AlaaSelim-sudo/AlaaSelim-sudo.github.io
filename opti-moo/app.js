...
(function(){
  ...
  load("app-core.js").then(()=>load("app-ui.js")).catch(err=>{console.error(err);const el=document.getElementById("runStatus");if(el){el.textContent="Startup error";el.className="status-pill";}alert(err.message);});
})();
